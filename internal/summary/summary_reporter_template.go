...
func NewSummaryReporterTemplate(config reporter.Config, db node.DBNodeMap) *SummaryReporterTemplate {
...
func (r *SummaryReporterTemplate) Process(ln *node.LogNode) error {
