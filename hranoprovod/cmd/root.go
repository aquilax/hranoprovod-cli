...
func GetApp() *cli.App {
	...
	a.Commands = []*cli.Command{
		newRegisterCommand(u, hranoprovod.Register),
		newBalanceCommand(u, hranoprovod.Balance),
		newLintCommand(u, hranoprovod.Lint),
		newReportCommand(u),
		newCSVCommand(u),
		newStatsCommand(u, hranoprovod.Stats),
		newSummaryCommand(u, hranoprovod.Summary),
		newGenCommand(u, a),
		newPrintCommand(u, hranoprovod.Print),
	}
	return a
}
